...
import 'package:dicoding_storyapp_awal/model/asset_response_detail.dart';
...
class StoryDetailController extends GetxController {
  ...
  var detailStory = AssetDetailStory(
    error: false,
  ...
  Future<AssetDetailStory> getStoryDetail(String storyId, String token) async {
    ...
    if (response.statusCode == 200) {
      ...
      return AssetDetailStory.fromJson(responseData);
    } else {
